function [meanmat,componentsonly] = plot_pca_fd(pcastr, matplt, harm, expand, cycle, colorwrd)
...
weightedcomponentsonly = zeros(length(fdmat),nharm);
componentsonly = zeros(length(fdmat),nharm);
if harm == 0
    harm = (1:nharm);
end
if length(dimfd) == 2
    ...
    for iharm = harm
        ...
        weightedcomponentsonly(:,iharm) = fac.*vecharm;
        componentsonly(:,iharm) = vecharm;
...
figure()
plot(x,weightedcomponentsonly)
if size(weightedcomponentsonly,2)==1
    legend('Component 1')
elseif size(weightedcomponentsonly,2)==2
    legend('Component 1','Component 2')
elseif size(weightedcomponentsonly,2)==3
    legend('Component 1','Component 2','Component 3')
elseif size(weightedcomponentsonly,2)==4
    legend('Component 1','Component 2','Component 3','Component 4')
end
title('Principal Components Weighted by Percentage of Variability Explained')
xlabel(['\fontsize{12} ',fdnames{1}])
...
elseif size(componentsonly,2)==2
    legend('Component 1','Component 2')
elseif size(componentsonly,2)==3
    legend('Component 1','Component 2','Component 3')
elseif size(componentsonly,2)==4
    legend('Component 1','Component 2','Component 3','Component 4')
end
title('Raw Principal Components')
xlabel(['\fontsize{12} ',fdnames{1}])